...
class BusViewModel @Inject constructor(
    ...
    fun startTcpServer() {
        val result = bus.start(
            ...
            Properties().apply {
                this[PropKeys.PROP_UDP_REGISTER_FLAG] =
                    Integer.parseUnsignedInt(_busUiState.value.registerFlag, FLAG_RADIX)
                this[PropKeys.PROP_UDP_REGISTER_SERVER_IP] = _busUiState.value.serverIp
                this[PropKeys.PROP_UDP_REGISTER_SERVER_PORT] = _busUiState.value.serverPort
                this[PropKeys.PROP_UDP_REGISTER_BROADCAST_INTERVAL] =
