...
object PropKeys {
    ...
    const val PROP_BROADCAST_PORT = "broadcast_port"
    const val PROP_BROADCAST_INTERVAL = "broadcast_interval"
    const val PROP_BROADCAST_DATA = "broadcast_data"
    const val PROP_BROADCAST_DEBUG_MODE = "broadcast_debug_mode"
    const val PROP_FLAG = "flag"
    const val PROP_SERVER_IP = "server_ip"
    const val PROP_SERVER_PORT = "server_port"
